...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [163 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2544640, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 22641240; uint32_t buffer_offset
	}, ; 160: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 22812248; uint32_t buffer_offset
	}, ; 161: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2038784, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 22833784; uint32_t buffer_offset
	} ; 162: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 24872568, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [24872568 x i8] zeroinitializer, align 1
